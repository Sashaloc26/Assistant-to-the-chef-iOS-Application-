...
//  Kitchen Helper
//
//  Created by Саша Тихонов on 15/05/2025.
//
...
let defaultRecipes: [DefaultRecipe] = [
    ...
    DefaultRecipe(
        name: "Bean soup",
        ingredients: ["Red kidney beans, dry - 1 cup", "Water or broth - 2-3 liters", "Yellow onion - 1 piece", "Carrot - 1 piece", "Vegetable oil", "Potatoes - 1-2 pieces", "Bay leaves - 2-3 pieces", "Sausage or smoked meats - 100-150 g", "Khmeli-suneli - 2 tsp", "Smoked paprika - 2-3 tsp", "Herbs - 1 bunch", "Salt - to taste", "Ground black pepper - to taste", "Vegetables", "Pork"],
    ...
    DefaultRecipe(
        ...
        ingredients: ["Meat (any!) - 500 g", "Honey - 2 tbsp", "Lemon juice - 1 tbsp", "Sesame seeds - 30-50 g", "Vegetable oil - 1-2 tbsp", "Salt - to taste", "Pepper - to taste", "Vegetables", "Pork"],
    ...
    DefaultRecipe(
        ...
        ingredients: ["Buckwheat groats - 130 g", "Chicken fillet - 300 g", "Frozen wild mushrooms - 150 g", "Hard cheese - 50 g", "Garlic - 1 clove", "10% cream - 100 g", "Vegetable oil - 2 tbsp", "Salt - 1/2 tsp", "Vegetables", "Chicken"],
    ...
    DefaultRecipe(
        name: "Pork chops",
        ingredients: ["Pork - 350 g", "Hard cheese - 100 g", "Yellow onion - 50 g", "Carrot - 50 g", "Garlic - 1-2 cloves", "Mayonnaise - 70-80 g", "Vegetable oil - 40 ml", "Salt - 0.25 tsp", "Ground black pepper", "Fresh parsley", "Vegetables", "Pork"],
    ...
    DefaultRecipe(
           ...
           instructions:
           "1. We'll combine the chopped ingredients directly in a salad bowl. The next ingredient is the fresh cucumber. It's recommended not to peel it. Of course, make sure to wash the cucumber well. Cut the cucumber into cubes similar in size to the sausage. Let's start with the boiled sausage. Cut it into small cubes.2. We'll simply grate the processed cheese on a coarse grater. (To make it easier to grate, you can chill the cheese in the freezer for about 15 minutes.)3. Peel the cooled boiled eggs and cut them into similar-sized cubes as the sausage and cucumber. The canned green peas are the final component of the salad. Drain the liquid, strain the peas, and transfer them to the salad bowl. We'll use mayonnaise as the dressing. Mix the salad, add salt to taste.",
           cookingTime: "20 min",
           calories: "1230 kcal",
           photo: "salad_tenderness",
           categoryName: "Salads",
           favourites: false
       ),
       DefaultRecipe(
           ...
           instructions:
           "1. Grate the cheese finely, add flour, and egg. Mix well. Shape the mixture into cheese sticks.2. Fry them in vegetable oil until golden brown.",
           cookingTime: "30 min",
           calories: "750 kcal",
           photo: "cheese_snacks",
           categoryName: "Snacks",
       ...
       DefaultRecipe(
           ...
           instructions:
           "1. Boil the eggs. Grate the cheese and eggs using a coarse grater. Grate the garlic using a fine grater. Finely chop the herbs and crab sticks. Mix everything together and dress with mayonnaise.2. Place one of the lavash sheets on the table. Carefully spread half of the filling over its entire surface. Then lay the second lavash sheet. Spread the second half of the filling. Now carefully roll up the lavash into a roll. You can wrap it in plastic wrap or foil.3. Put the appetizer in the refrigerator for 2-3 hours. Before serving, slice into pieces about 3-4 cm thick.",
           cookingTime: "35 min",
           calories: "490 kcal",
           photo: "lavash_snack",
           categoryName: "Snacks",
       ...
       DefaultRecipe(
           ...
           instructions:
            "1. Peel the potatoes. Grate them using a Korean carrot grater.2. Place the grated potatoes in a colander and rinse them under running water. Let excess liquid drain. Then, season the potatoes generously with salt.3. Fry them.",
           cookingTime: "30 min",
           calories: "550 kcal",
           photo: "fries_pie",
           categoryName: "Snacks",
       ...
       DefaultRecipe(
           ...
           instructions:
          "1. Preheat the oven to 180°C. Grease a springform pan with butter. Using a blender, finely crush the biscuits. Add melted butter, sugar, and salt, mix well. Press the mixture into the pan, evenly distributing it along the bottom and edges. Place the cheesecake crust in the oven. Reduce the temperature to 150°C. Bake for 12-15 minutes. Then cool on a wire rack.2. Using a mixer on medium speed, beat the cream cheese (at room temperature). Gradually add sugar, lemon zest, lemon juice, and salt. Beat in one egg at a time, then add the heavy cream. Beat until smooth.3. Wrap the bottom of the pan with foil. Pour the prepared filling over the crust, lightly tap on the table to remove air bubbles. Place the pan in a deep baking dish. Pour boiling water into the baking dish to reach halfway up the sides of the pan. Place the cheesecake in the preheated oven for 10-15 minutes. Then reduce the temperature to 110-120°C and bake until set, about 1.5 hours. Remove from water, leave in the turned-off oven for 20 minutes. Cool completely, then refrigerate overnight before serving.",
           cookingTime: "440 min",
           calories: "1400 kcal",
       ...
       DefaultRecipe(
           ...
           instructions:
          "1. Crush the mint with sugar to release its juice.2. Add lemon or lime juice. Crush again until the sugar is completely dissolved.3. Add ice (more than half a glass) and pour in mineral water. Prepare the cocktail in a glass with a volume of at least 300 ml. Serve the mojito with a straw.",
           cookingTime: "10 min",
           calories: "80 kcal",
           photo: "mojito",
